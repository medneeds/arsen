CREATE OR REPLACE FUNCTION public.complete_internal_transfer_atomic(p_request_id uuid, p_target_patient_id uuid, p_destination jsonb, p_hospital_unit_id uuid, p_state_id uuid, p_repoint_reason text DEFAULT NULL::text, p_current_user_id uuid DEFAULT NULL::uuid, p_department text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
