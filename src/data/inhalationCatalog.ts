...
export const INHALATION_CATALOG: InhalationPreset[] = [
  ...
  { match: ['acetilcistein', 'n-acetilcistein', 'fluimucil'], mode: 'nebulization', nebDose: '300', nebDoseUnit: 'mg', diluent: 'SF0,9%', diluentVolume: '3', oxygenFlow: '6', stageDuration: '10', inhalationInterface: 'mascara', posology: '8/8h', inhalationOrientation: 'Mucolítico — pode causar broncoespasmo; considerar pré-uso de broncodilatador em asmáticos/DPOC.' },
  // Nebulização apenas com Soro Fisiológico (umidificação / fluidificação de secreção)
  { match: ['soro fisiologico nebul', 'sf 0,9 nebul', 'nacl 0,9 nebul', 'soro fisiologico inal', 'cloreto de sodio 0,9 inal', 'cloreto de sodio 0,9 nebul'], mode: 'nebulization', nebDose: '5', nebDoseUnit: 'mL', diluent: 'puro', diluentVolume: '', oxygenFlow: '6', stageDuration: '10', inhalationInterface: 'mascara', posology: '6/6h', inhalationOrientation: 'Nebulização com SF 0,9% puro — hidratação de via aérea / fluidificação de secreção.' },
