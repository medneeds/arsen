...
export const HIGH_ALERT_OPTIONS: MedicationEntry[] = [
  ...
  { id: 'ha-ins-glargina', name: 'Insulina Glargina (Lantus / Toujeo / Basaglar)', presentation: '100UI/mL ou 300UI/mL - Caneta/Frasco', defaultDose: 'Conforme esquema', defaultRoute: 'Subcutânea', defaultPosology: '1x/dia', defaultSchedule: '22h', instructions: 'Insulina basal de ação prolongada. Abre o assistente de insulinoterapia.', category: 'high_alert', highAlert: true },
  { id: 'ha-ins-detemir', name: 'Insulina Detemir (Levemir)', presentation: '100UI/mL - Caneta/Frasco', defaultDose: 'Conforme esquema', defaultRoute: 'Subcutânea', defaultPosology: '12/12h ou 1x/dia', defaultSchedule: '08h', instructions: 'Insulina basal de ação prolongada. Abre o assistente de insulinoterapia.', category: 'high_alert', highAlert: true },
  { id: 'ha-ins-degludeca', name: 'Insulina Degludeca (Tresiba)', presentation: '100UI/mL ou 200UI/mL - Caneta', defaultDose: 'Conforme esquema', defaultRoute: 'Subcutânea', defaultPosology: '1x/dia', defaultSchedule: '22h', instructions: 'Insulina basal ultraprolongada. Abre o assistente de insulinoterapia.', category: 'high_alert', highAlert: true },
  { id: 'ha-ins-lispro', name: 'Insulina Lispro (Humalog / Liprolog)', presentation: '100UI/mL - Caneta/Frasco', defaultDose: 'Conforme esquema', defaultRoute: 'Subcutânea', defaultPosology: 'Antes das refeições', defaultSchedule: '07h-12h-18h', instructions: 'Insulina ultrarrápida (bolus). Abre o assistente de insulinoterapia.', category: 'high_alert', highAlert: true },
  { id: 'ha-ins-aspart', name: 'Insulina Aspart (NovoRapid / Fiasp)', presentation: '100UI/mL - Caneta/Frasco', defaultDose: 'Conforme esquema', defaultRoute: 'Subcutânea', defaultPosology: 'Antes das refeições', defaultSchedule: '07h-12h-18h', instructions: 'Insulina ultrarrápida (bolus). Abre o assistente de insulinoterapia.', category: 'high_alert', highAlert: true },
  { id: 'ha-ins-glulisina', name: 'Insulina Glulisina (Apidra)', presentation: '100UI/mL - Caneta/Frasco', defaultDose: 'Conforme esquema', defaultRoute: 'Subcutânea', defaultPosology: 'Antes das refeições', defaultSchedule: '07h-12h-18h', instructions: 'Insulina ultrarrápida (bolus). Abre o assistente de insulinoterapia.', category: 'high_alert', highAlert: true },
