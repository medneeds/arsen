...
export const DESTINATION_SECTORS: DestinationSectorOption[] = [
  ...
  // UTIs
  { value: "red", label: "UTI 1", group: "UTI/UCI", mapTitle: "UTI 1" },
  { value: "yellow", label: "UTI 2", group: "UTI/UCI", mapTitle: "UTI 2" },
  // UCIs
  { value: "blue", label: "UCI 1", group: "UTI/UCI", mapTitle: "UCI 1" },
  { value: "outside", label: "UCI 2", group: "UTI/UCI", mapTitle: "UCI 2" },
