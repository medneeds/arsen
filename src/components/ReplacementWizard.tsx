...
function buildSuggestions(d: Disorder, sev: Severity, value: string): SuggestionOption[] {
  ...
  switch (d) {
    ...
    case "hipoNa": {
      if (sev === "grave") return [
        {
          id: "hipoNa-grave-prep-sf-nacl20",
          title: "NaCl 3% PREPARADA — SF 0,9% + NaCl 20% (mais usada)",
          rationale: "Padrão hospitalar quando há NaCl 20% (amp 10 mL = 2 g). Preparo de 500 mL de NaCl 3%: retirar 55 mL da bolsa SF 0,9% 500 mL e adicionar 55 mL (≈ 6 amp 10 mL) de NaCl 20% — concentração final ≈ 3% (≈ 513 mEq Na/L).",
          source: "AMIB · SBN · UpToDate (preparação magistral)",
          items: [{
            name: "NaCl 3% PREPARADA (SF 0,9% + NaCl 20%)",
            presentation: "Bolsa final 500 mL — preparo magistral",
            dose: "Bolus 150 mL",
            route: "Intravenosa",
            posology: "Em 10-20 min · repetir até 3x SN",
            instructions: `PREPARO (enfermagem): retirar 55 mL da bolsa SF 0,9% 500 mL e desprezar; adicionar 55 mL (≈ 6 amp 10 mL) de NaCl 20%. Homogeneizar e identificar como "NaCl 3%". Meta: ↑Na 4-6 mEq/L em 6h, MÁX 8 mEq/L em 24h (mielinólise pontina). Preferir CVC. Na atual: ${v}.`,
          }],
        },
        {
          id: "hipoNa-grave-prep-sf-nacl10",
          title: "NaCl 3% PREPARADA — SF 0,9% + NaCl 10%",
          rationale: "Quando o serviço só dispõe de NaCl 10% (amp 10 mL = 1 g). Preparo de 500 mL: retirar 110 mL de SF 0,9% 500 mL e adicionar 110 mL de NaCl 10% — concentração final ≈ 3%.",
          source: "AMIB · SBN · prática hospitalar consagrada",
          items: [{
            name: "NaCl 3% PREPARADA (SF 0,9% + NaCl 10%)",
            presentation: "Bolsa final 500 mL — preparo magistral",
            dose: "Bolus 150 mL",
            route: "Intravenosa",
            posology: "Em 10-20 min · repetir até 3x SN",
            instructions: `PREPARO (enfermagem): retirar 110 mL da bolsa SF 0,9% 500 mL e desprezar; adicionar 110 mL (≈ 11 amp 10 mL) de NaCl 10%. Homogeneizar e rotular "NaCl 3%". Meta: ↑Na 4-6 mEq/L em 6h, máx 8 mEq/L em 24h. Na atual: ${v}.`,
          }],
        },
        {
          id: "hipoNa-grave-prep-ad-nacl20",
          title: "NaCl 3% PREPARADA — AD + NaCl 20% (sem SF disponível)",
          rationale: "Alternativa quando não há SF 0,9% pronta. Preparo de 500 mL: 425 mL de AD estéril + 75 mL (≈ 7-8 amp 10 mL) de NaCl 20% — concentração final ≈ 3%.",
          source: "AMIB · ASN · preparação magistral",
          items: [{
            name: "NaCl 3% PREPARADA (AD + NaCl 20%)",
            presentation: "Bolsa final 500 mL — preparo magistral",
            dose: "Bolus 150 mL",
            route: "Intravenosa",
            posology: "Em 10-20 min · repetir até 3x SN",
            instructions: `PREPARO (enfermagem): em frasco/bolsa estéril, misturar 425 mL de Água Destilada estéril + 75 mL (≈ 7-8 amp 10 mL) de NaCl 20%. Homogeneizar e rotular "NaCl 3%". Preferir CVC. Na atual: ${v}.`,
          }],
        },
        {
          id: "hipoNa-grave-bic",
          title: "NaCl 3% — BIC de manutenção (após bolus)",
          rationale: "Após bolus inicial, manter infusão calculada por déficit de Na (ΔNa × 0,6 × peso ÷ 0,513) para evitar correção excessiva (>8 mEq/L/24h).",
          source: "AMIB UTI · European HNa Guidelines 2014",
          items: [{
            name: "NaCl 3% PREPARADA — BIC",
            presentation: "Bolsa 500 mL (qualquer dos preparos acima)",
            dose: "Calcular: ΔNa × 0,6 × peso ÷ 0,513",
            route: "Intravenosa",
            posology: "BIC contínua",
            instructions: `Velocidade típica 15-30 mL/h (≈ 0,5-1 mL/kg/h). Na sérico 2/2h nas primeiras 12h. REDUZIR/SUSPENDER se ↑Na > 8 mEq/L em 24h. Preferir CVC. Na atual: ${v}.`,
          }],
        },
      ];
      if (sev === "moderada") return [
