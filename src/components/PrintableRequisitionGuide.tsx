...
export async function buildRequisitionGuideHtml(
  ...
  return buildNormaZeroDocument({
    ...
    bodyHtml,
    // Parecer: assinatura do solicitante está no solicitanteSignBlock (corpo)
    // e a assinatura do parecerista está no parecerResponseBlock (corpo).
    // Nenhuma signature adicional no rodapé para evitar duplicação.
