...
const sectorInfo: Record<string, { title: string; subtitle: string; icon: string; gradientClass: string }> = {
  ...
  ucc: { title: "UCC", subtitle: "Unidade de Cuidados Clínicos", icon: "🟣", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  neuro_01: { title: "Neuro 01", subtitle: "Enfermaria Neuro 01", icon: "🧠", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  neuro_02: { title: "Neuro 02", subtitle: "Enfermaria Neuro 02", icon: "🧠", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  clinica_cirurgica: { title: "Clínica Cirúrgica", subtitle: "Enfermaria Clínica Cirúrgica", icon: "🏥", gradientClass: "bg-gradient-to-r from-released-soft/20 to-released-soft/10" },
  enfermaria_transicao: { title: "Enf. Transição", subtitle: "Enfermaria de Transição", icon: "🔄", gradientClass: "bg-gradient-to-r from-warning-soft/20 to-warning-soft/10" },
  enfermaria_vascular: { title: "Enf. Vascular", subtitle: "Enfermaria Vascular", icon: "💗", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  ...
  observacao_clinica: { title: "Obs. Clínica", subtitle: "Observação Clínica", icon: "👁️", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  internacao_ue: { title: "Posto de Internação", subtitle: "Posto de Internação", icon: "🏨", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  ue_vertical: { title: "UE Vertical", subtitle: "UE Vertical", icon: "⬆️", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  ue_horizontal: { title: "UE Horizontal", subtitle: "UE Horizontal", icon: "➡️", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  riv: { title: "RIV", subtitle: "Referência de Internação Vascular", icon: "🩸", gradientClass: "bg-gradient-to-r from-critical-soft/20 to-critical-soft/10" },
  cc_preparo: { title: "CC Preparo", subtitle: "Centro Cirúrgico - Preparo", icon: "⚕️", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  cc_bloco: { title: "CC Bloco", subtitle: "Centro Cirúrgico - Bloco", icon: "🔪", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
  cc_rpa: { title: "CC RPA", subtitle: "Centro Cirúrgico - RPA", icon: "💤", gradientClass: "bg-gradient-to-r from-muted/20 to-muted/10" },
};
